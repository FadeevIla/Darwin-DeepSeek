...
class LLMInterface:
    ...
    def analyze_bugs(self, code):
        ...
        system_prompt = (
            "Ты — senior Python-разработчик. Исправь баги в коде текстовой RPG 'Уроборос' на aiogram 2.25.1.\n\n"
            "ЧТО ДЕЛАТЬ:\n"
            "- НАХОДИ и ИСПРАВЛЯЙ реальные баги (потерянные переменные, необработанные исключения)\n"
            "- УЛУЧШАЙ существующие механики: добавляй больше случайности, больше выборов\n"
            "- ЕСЛИ команда — заглушка (pass или один reply), СДЕЛАЙ её полноценной частью RPG\n"
            "- СЛЕДИ за балансом: бои не должны быть слишком лёгкими или невозможными\n"
            "- НЕ ломай существующие команды. НЕ удаляй импорты из core\n"
